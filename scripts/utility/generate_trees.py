...
@asynccontextmanager
async def use_models(cfg: Config, raw_cfg: DictConfig):
    ...
    clusterer_cfg = raw_cfg.semantic_cluster_model
    clusterer_gpus = cfg.devices.semantic_cluster
    clusterer = construct_semantic_clusterer(clusterer_cfg, f"cuda:{clusterer_gpus[0]}")
